...
//    wallShadow->setGlobalZOrder(Z_WALLS);
    ...
    parallaxFour = ParallaxBG::create("parallaxMount002gt.png",Z_PLX4,Color3B(55,75,52),levelWidthHalf);
    this->addChild(parallaxFour);
    
    parallaxFive = ParallaxBG::create("parallaxMount001gt.png",Z_PLX5,Color3B(35,155,40),levelWidthHalf);
